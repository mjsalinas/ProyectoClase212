...
import ServiceRegisterScreen from '../screens/services/ServiceRegisterScreen';

export type RootStackParamList = {
    Login: undefined,
    Tabs: {email:string},
    ServiceRegistry: undefined,
    ServiceRegister: undefined,
}
...
export default function StackNavigator() {
    return(
        <Stack.Navigator initialRouteName='Login' screenOptions={{headerShown: false}}>
            ...
            <Stack.Screen name="ServiceRegister" component={ServiceRegisterScreen} />
        </Stack.Navigator>
    );
}